...
interface CircularCarouselProps {
  ...
  getCurrentSponsor: (value:  any) => void;
  images: any[];
  carouselIndex: number;
}

const SponsorsCircularCarousel: React.FC<CircularCarouselProps> = ({flexDirection, getCurrentSponsor, images, carouselIndex}) => {
    ...
    useEffect(() => {
        ...
        setActiveSlide(slides[carouselIndex]); 
        setRotate(angle * carouselIndex);
    ...
    }, [carouselIndex, wheelWidth, flexDirection]);
    ...
    const handleSlideClick = (e: any) => {
        ...
        getCurrentSponsor(slides[nextIndex - 1])
...
export default SponsorsCircularCarousel;