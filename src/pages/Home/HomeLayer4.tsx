                ...
                <div className="home-layer-4-container">
                    ...
                    <div className="get-involved-container" style={{zIndex: 3}}>
                            ...
                            <div className="get-involved-grid" style={{zIndex:4}}>
                                ...
                                <div className="grid-item" style={{boxShadow: `6px 6px #14283a`}}><Link to="/minutes">{t("MINUTES")}</Link></div>
                                <div className="grid-item" style={{boxShadow: `6px 6px #14283a`}}><Link to="/blog">{t('BLOG')}</Link></div>
                                <div className="grid-item" style={{boxShadow: `6px 6px #14283a`}}><Link to="https://cssa-aei--101week-kits.square.site/">{t("MERCH")}</Link></div>
                                <div className="grid-item" style={{boxShadow: `6px 6px #14283a`}}><Link to="/about">{t("CONTACT")}</Link></div>
                                <div className="grid-item" style={{boxShadow: `6px 6px #14283a`}}><Link to="https://docs.google.com/forms/d/e/1FAIpQLSfxvdZL2eKyZj15OGu6VKBEWURQQ9kW7LGDidkwsXRUg-x3Ug/viewform">{t('REQUEST ITEM')}</Link></div>
                            </div>
                    </div>
       ...
       <div className="home-layer-4-container" style={{overflowY: `visible`, flexDirection: `column`}}>
            ...
            <div className="get-involved-container" style={{height: `80vh`}}>
                    ...
                    <div className="get-involved-grid">
                        ...
                        <div className="grid-item"><Link to="/minutes">{t("MINUTES")}</Link></div>
                        <div className="grid-item"><Link to="/blog">{t('BLOG')}</Link></div>
                        <div className="grid-item"><Link to="https://cssa-aei--101week-kits.square.site/">{t("MERCH")}</Link></div>
                        <div className="grid-item"><Link to="/about">{t("CONTACT")}</Link></div>
                        <div className="grid-item"><Link to="https://docs.google.com/forms/d/e/1FAIpQLSfxvdZL2eKyZj15OGu6VKBEWURQQ9kW7LGDidkwsXRUg-x3Ug/viewform">{t('REQUEST ITEM')}</Link></div>
                    </div>
            </div>
